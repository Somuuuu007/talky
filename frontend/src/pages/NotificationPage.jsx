      ...
      <section className="space-y-4">
            <h2 className="text-xl flex items-center gap-2 font-semibold">
              <UserCheckIcon className="size-5 text-primary" />
               ...
               Friend Requests
               <span className="badge ml-2 badge-primary">{incomingRequests.length}</span>
               </h2>

               <div className="space-y-3">
                {incomingRequests.map((request) => (
                  <div key={request._id} className="card bg-base-200 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="card-body p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm my-1">{notification.recipient.fullName} has accepted your friend request.</p>
